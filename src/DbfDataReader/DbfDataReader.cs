...
namespace DbfDataReader
{
    public class DbfDataReader : DbDataReader, IDbColumnSchemaGenerator
    {
        ...
        {
            _options = options;
            DbfTable = new DbfTable(path, options.Encoding, options.CustomMemoType);
        ...
        {
            _options = options;
            DbfTable = new DbfTable(stream, options.Encoding, options.CustomMemoType);
            DbfRecord = new DbfRecord(DbfTable);
        }
        ...
        {
            _options = options;
            DbfTable = new DbfTable(stream, memoStream, options.Encoding, options.CustomMemoType);
            DbfRecord = new DbfRecord(DbfTable);
        }
